...
{
    public partial class TransferSimpleLong : Form
    {
        public TransferSimpleLong()
        {
            InitializeComponent();
        }
        ...
        private void TransferSimpleLong_Load(object sender, EventArgs e)
        {
        ...
        private void btntransfer50_Click(object sender, EventArgs e)
        {
            ...
            if (baldata >= 10)
            {
                string newquery = ("UPDATE customer SET  BalanceSimple = BalanceSimple - 50,BalanceLong = BalanceLong + 50 WHERE Pin = '" + pin_urdu.SetValuepin + "'");
        ...
        private void btntransfer100_Click(object sender, EventArgs e)
        {
            ...
            if (baldata >= 10)
            {
                string newquery = ("UPDATE customer SET  BalanceSimple = BalanceSimple - 100,BalanceLong = BalanceLong + 100 WHERE Pin = '" + pin_urdu.SetValuepin + "'");
                SQLiteCommand cmd = new SQLiteCommand(newquery, con);
                com.CommandText = newquery;
                com.CommandType = CommandType.Text;
                com.ExecuteNonQuery();
        ...
        private void btntransfer20_Click(object sender, EventArgs e)
        {
            ...
            if (baldata >= 10)
            {
                string newquery = ("UPDATE customer SET  BalanceSimple = BalanceSimple - 20,BalanceLong = BalanceLong + 20 WHERE Pin = '" + pin_urdu.SetValuepin + "'");
                SQLiteCommand cmd = new SQLiteCommand(newquery, con);
                com.CommandText = newquery;
                com.CommandType = CommandType.Text;
                com.ExecuteNonQuery();
        ...
        private void btntransfer10_Click(object sender, EventArgs e)
        {
            ...
            if (baldata >= 10)
            {
                string newquery = ("UPDATE customer SET  BalanceSimple = BalanceSimple - 10,BalanceLong = BalanceLong + 10 WHERE Pin = '" + pin_urdu.SetValuepin + "'");
                SQLiteCommand cmd = new SQLiteCommand(newquery, con);
                com.CommandText = newquery;
                com.CommandType = CommandType.Text;
                com.ExecuteNonQuery();
