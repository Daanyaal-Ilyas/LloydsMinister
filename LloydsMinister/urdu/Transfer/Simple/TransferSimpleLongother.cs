...
namespace LloydsMinister.urdu.Transfer.Simple
{
    public partial class TransferSimpleLongother : Form
    {
        ...
        private void btntransfer_Click(object sender, EventArgs e)
        {
            ...
            if (baldata >= data)
            {
                string store = ("INSERT INTO simple_historyen (date,time,description,Pin,amount) VALUES ('" + date + "','" + time + "','" + texten + "','" + pin_urdu.SetValuepin + "','" + txttransferammount.Text + "')");
                string storeurdu = ("INSERT INTO simple_historyurdu (date,time,description,Pin,amount) VALUES ('" + date + "','" + time + "','" + texturdu + "','" + pin_urdu.SetValuepin + "','" + txttransferammount.Text + "')");
